<section style="min-height: calc(100vh - 83px)" class="light-bg">
  ...
  <div class="container">
    ...
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_areas" role="tab" data-toggle="tab">Areas de atuação</a></li>
    ...
    <div class="tab-content">
      <div id="tab_areas" class="tab-pane active">
         <div class="container-fluid">
          <h2 class="text-center"><strong>Gerenciar Areas</strong></h2>
          <a id="btn_add_area" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar area</i></a>
          <table id="dt_area" class="table table-striped table-bordered">
            <thead>
      ...
      <div id="tab_cliente" class="tab-pane">
        <div class="container-fluid">
          <h2 class="text-center"><strong>vizualizar clientes cadastrados!</strong></h2>
      ...
      <div class="modal-body">
        <form id="form_area">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input id="area_name" name="area_name" class="form-control" maxlength="100">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <img id="area_img_path" src="" style="max-height: 400px; max-height: 400px">
              <label class="btn btn-block btn-info">
                <i class="fa fa-upload"></i>&nbsp;&nbsp;Importar imagem
                <input type="file" id="btn_upload_area_img" accept="image/*" style="display: none;">
              </label>
              <input id="area_img" name="area_img" hidden>
              <span class="help-block"></span>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <textarea id="area_description" name="area_description" class="form-control"></textarea>
              <span class="help-block"></span>
            </div>
          </div>

          <div class="form-group text-center">
            <button type="submit" id="btn_save_area" class="btn btn-primary">
